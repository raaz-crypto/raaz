...
instance Hash SHA1 where
  startHashCxt _ = SHA1Cxt $ SHA1 0x67452301
                                  0xefcdab89
                                  0x98badcfe
                                  0x10325476
                                  0xc3d2e1f0
...
instance Hash SHA224 where
  startHashCxt _ = SHA224Cxt $ SHA256 0xc1059ed8
                                      0x367cd507
                                      0x3070dd17
                                      0xf70e5939
                                      0xffc00b31
...
instance Hash SHA256 where
  ...
  startHashCxt _ = SHA256Cxt $ SHA256 0x6a09e667
                                      0xbb67ae85
                                      0x3c6ef372
                                      0xa54ff53a
                                      0x510e527f
...
instance Hash SHA512 where
  ...
  startHashCxt _ = SHA512Cxt $ SHA512 0x6a09e667f3bcc908
                                      0xbb67ae8584caa73b
                                      0x3c6ef372fe94f82b
                                      0xa54ff53a5f1d36f1
                                      0x510e527fade682d1
...
instance Hash SHA384 where
  startHashCxt _ = SHA384Cxt $ SHA512 0xcbbb9d5dc1059ed8
                                      0x629a292a367cd507
                                      0x9159015a3070dd17
                                      0x152fecd8f70e5939
                                      0x67332667ffc00b31
