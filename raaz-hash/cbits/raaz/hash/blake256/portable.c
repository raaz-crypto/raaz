...
void initializevariables(){
	...
	constant[0] = 0x243F6A88;	constant[1] = 0x85A308D3; 	constant[2] = 0x13198A2E; 	constant[3] = 0x03707344;
	constant[4] = 0xA4093822;	constant[5] = 0x299F31D0;	constant[6] = 0x082EFA98;	constant[7] = 0xEC4E6C89;
	constant[8] = 0x452821E6;	constant[9] = 0x38D01377;	constant[10] = 0xBE5466CF;	constant[11] = 0x34E90C6C;
	constant[12] = 0xC0AC29B7;	constant[13] = 0xC97C50DD;	constant[14] = 0x3F84D5B5;	constant[15] = 0xB5470917;
	
}
	


void initialize_matrix(Hash hash, Salt salt, word *counter){
	...
	v[3][0] = counter[0] ^ constant[4]; 
	v[3][1] = counter[0] ^ constant[5]; 
	v[3][2] = counter[1] ^ constant[6]; 
	v[3][3] = counter[1] ^ constant[7];
	
}	
void raazHashBlake256PortableCompress(Hash hash, Salt salt, uint64_t *counte, int nblocks, Block *mesg){
	...
	while(nblocks > 0){
		...
		*counte = *counte + 512;
		coun[0] = (word)*counte;
		coun[1] = (word)(*counte >> 32);
				
		initialize_matrix(hash, salt, coun);
